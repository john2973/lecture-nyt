...
def test():
  ...
  # test 3: test project score

  test_project_score1 = [88, 90, 92, 94]

  expected_project_score = 88 + 90 + 92 + 94

  if calculate_project_score(test_project_score1) == expected_project_score:
      print('TEST 2.5 passed')
  else:
      print('TEST 2.5 failed')

# test 4: test midterm score

  test_midtermscore1 = [90, 90, 92, 92]

  expected_midtermscore = 90 + 90 + 92 + 92

  if calculate_midterm_score(test_midtermscore1) == expected_midtermscore:
